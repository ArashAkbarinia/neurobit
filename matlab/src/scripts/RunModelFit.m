...
for pp = 1:length(WhichColours)
  switch WhichColours{pp}
    case {'g', 'green'}
      ...
      FittingData.kolor = G;
      FittingData.data36 = lsYFrontiers.(FittingData.category).data36;
      FittingData.data58 = lsYFrontiers.(FittingData.category).data58;
      FittingData.data81 = lsYFrontiers.(FittingData.category).data81;
