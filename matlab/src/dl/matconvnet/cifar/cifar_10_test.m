function info = cifar_10_test(varargin)

% experiment and data paths
% opts.expDir = 'data/fcn32s-voc11';
opts.expDir = '/home/arash/Software/Repositories/neurobit/data/dl/cifar/cifar-10/results';
% opts.dataDir = 'data/voc11';
opts.dataDir = '/home/arash/Software/Repositories/neurobit/data/dl/cifar/cifar-10/cifar-10-lenet-dagnn';
opts.modelPath = '/home/arash/Software/Repositories/neurobit/data/dl/cifar/cifar-10/cifar-10-lenet-dagnn/net-epoch-45.mat';
opts.modelFamily = 'matconvnet';
[opts, varargin] = vl_argparse(opts, varargin);

% experiment setup
% opts.imdbPath = fullfile(opts.expDir, 'imdb.mat');
opts.imdbPath = '/home/arash/Software/Repositories/neurobit/data/dl/cifar/cifar-10/cifar-10-matlab/imdb-cifar-10.mat';
opts.vocEdition = '11';
...
resPath = fullfile(opts.expDir, 'results-cifar-10-lenet-dagnn.mat');
