function [xi, yi] = CorssOverSpectra(spectra1, wavelength1, spectra2, wavelength2)
...
[xi, yi] = polyxpoly(signal1.wavelength, signal1.spectra, signal2.wavelength, signal2.spectra);
