...
TermsPath = strrep(FunctionPath, 'matlab/src/experiments/wcs/WcsResults', 'data/WCS-Data-20110316/BK-term.txt');
DicPath = strrep(FunctionPath, 'matlab/src/experiments/wcs/WcsResults', 'data/WCS-Data-20110316/BK-dict.txt');
ChipsTablePath = strrep(FunctionPath, 'matlab/src/experiments/wcs/WcsResults', 'data/WCS-Data-20110316/cnum-vhcm-lab-new.txt');
...
if ConvertToEllipsoidColours
  EllipsoidDicMatPath = strrep(FunctionPath, 'matlab/src/experiments/wcs/WcsResults', 'matlab/data/mats/EllipsoidDic.mat');
