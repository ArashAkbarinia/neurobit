function berkeley_benchmark_multiscale_multicore
benchdir='BENCH';
pres='gray'
alg='full_cpcp_multiscale'
...
resultCell=startmulticoremaster(@berkeley_benchmark_multiscale_multicore_task, parameterCell);
