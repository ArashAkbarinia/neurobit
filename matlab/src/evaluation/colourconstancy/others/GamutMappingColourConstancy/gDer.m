...
% GDER: Support function for gamut_mapping.m
%
%   Computes the Gaussian derivative of an image. When iorder and jorder
%   are zero, then the image is smoothed at scale sigma.
%
