function [] = PlotCieXyLocus()
% colour representation of chromaticity diagram
% original source code downloaded from
% https://mathworks.com/matlabcentral/fileexchange/40640-computational-colour-science-using-matlab-2e
...
WcsRelativePath = ['data', filesep, 'mats', filesep, 'visualisation', filesep, 'colours', filesep, 'CIEXYLocus.mat'];
FilePath = strrep(FunctionPath, FunctionRelativePath, WcsRelativePath);

% load spectral locus xy values at 1-nm intervals
CieXyzLocus = load(FilePath);
locus = CieXyzLocus.locus;
