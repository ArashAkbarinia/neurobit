...
% ShowMaskAsOverlay Show segmentation (mask) with user-specified parameters
%                   transparency/color as overlay on image
%
...
validateattributes(opacity, {'double'}, {'scalar'}, mfilename, 'opacity', 1);
